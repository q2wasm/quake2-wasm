...
typedef int32_t print_level_t;

typedef int32_t multicast_t;

typedef int32_t sound_channel_t;

typedef vec_t sound_attn_t;

typedef int32_t config_string_t;
...
typedef int32_t content_flags_t;

typedef int32_t surface_flags_t;

typedef int32_t box_edicts_area_t;
...
enum { TAG_GAME	 = 765, TAG_LEVEL = 766 };
...
typedef struct
{
	...
	void (*sound)(edict_t *ent, sound_channel_t channel, int32_t soundindex, vec_t volume, sound_attn_t attenuation, vec_t timeofs);
	void (*positioned_sound)(const vec3_t *origin, edict_t *ent, sound_channel_t channel, int32_t soundindex, vec_t volume, sound_attn_t attenuation, vec_t timeofs);
	...
	int32_t (*BoxEdicts)(const vec3_t *mins, const vec3_t *maxs, edict_t **list, int32_t maxcount, box_edicts_area_t areatype);
